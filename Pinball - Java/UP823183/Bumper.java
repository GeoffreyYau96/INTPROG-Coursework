import java.awt. *;
/**
 * Bumper class ingerits the parameters of PinballObject class.
...
public class Bumper extends PinballObject
{
     ...
     */
    public Bumper(int xPos, int yPos, int xVel, int yVel, Color objectColor, double objectRadius, Machine theMachine)
    {
